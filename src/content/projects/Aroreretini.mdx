...
This site was made using [Tailwind](https://tailwindcss.com/), [Astro](https://astro.build/)[ & Tina](https://tina.io/).
...
If you'd like some help getting it setup, [don't hesitate to reach out](https://aroreretini.dev/contact)—I'd be delighted to help you.
