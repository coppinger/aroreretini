...
The goal was to learn Svelte & SvelteKit, but ended up taking me through several technologies:

* [Prisma](https://www.prisma.io/) (an ORM)
* [Pocketbase](https://pocketbase.io/)/SQLite
* [Supabase](supabase.com/)/PostgreSQL

## 0. TL;DR 🗒️

* I set out to learn Svelte, and ended up building a web app from scratch
* I heavily leaned on AI to do so, using ChatGPT & [Cursor](https://cursor.sh/) (VS Code fork w/ deep ChatGPT integrations)
* I ended up building Dwarf, a simple domain name marketplace
* I learnt lots, and a had a great time doing so!
